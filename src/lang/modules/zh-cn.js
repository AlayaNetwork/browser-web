...
export default {
  menu: {
    ...
    proposal: "治理提案",
    tokens: "令牌",
    erc20Tokens: "ARC20热门令牌",
    erc20Transfer: "ARC20 交易",
    erc721Tokens: "ARC721热门令牌",
  ...
  tips: {
    ...
    其中 W为初始发行1亿，n为当前增发周期序号，创世区块开始序号为1，a%为增发比例，当前为5%`,
    ...
    Staking相关系统合约包含<br />
    RewardManagerPool（atp1zqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqr5jy24r），DelegateRewardPool（atp1zqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqxxwje8t）`,
  ...
  fund: {
    title: "基金会地址",
    totalBalance: "自由金总余额 (ATP)",
    totalLocked: "锁仓金总余额 (ATP)",
    pageTotal: `总计 <b class="black">{0}</b> 个地址`,
    tAddress: "地址",
    tBalance: "自由金余额 (ATP)",
    tLockedBalance: "锁仓金余额 (ATP)"
  },
  ...zhLocale
};
